...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, NotificationSettingsComponent], // ADD MODAL COMPONENT
  animations: [
    trigger('pulse', [
...
export class Navbar implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    this.pushNotificationService.isSubscribed.subscribe(isSubscribed => {
      this.isPushEnabled = isSubscribed;
    });
  }
  ...
  async initializePushNotifications(): Promise<void> {
    const permission = await this.pushNotificationService.notificationPermission.toPromise();
